...
const cvData = {
  ...
  experience: [
    ...
    },
    {
      ...
      location: "Singapore",
      bullets: [
        "Led the 0 to 1 credit product, converting debit clients onto credit",
    ...
    },
    {
      ...
      company: "Empala, Antler SG4 (Fintech)",
      period: "Mar 2020 – Sep 2021",
      location: "Singapore",
      bullets: ["Took a wage access product from zero through discovery, regulatory clearance, payroll partner integrations and full launch in market"]
    },
    {
...
(async () => {
  const outputPath = path.resolve('data/generated/custom_cv.pdf');
  try {
